...
const HeaderButtons = () =>{
    ...
    return (
        <Box className={classes.wrapper}>
        {
            ...
            <Link style={{ textDecoration: 'none',color: 'black'}} to={'/sell'}><Box >
                <Button className={classes.sell} variant='outlined' onClick={() => openSell() }><img src={plusUrl} className={classes.sellImg}/>Sell</Button>    
            </Box></Link>
